...
Last updated: 2026-09-04 16:20 (stuck received guard 2m `recover_stuck_received_sessions` — prod dispatched, dev synced — sesi 45209362 stuck 68m root-caused via manual claim_job + recovery)
...
- Supabase projects: dev `ceqcitzbosqzxpbtlpfn` (**49 migrations** — 43 repo lama + 3 Aichixia/reasoning-pref 03 Sep + **nemotron-rotation `20260904090000` + bot-text seeds `20260904120000` + stuck-received `20260904150000` (applied dev via MCP `recover_stuck_received_sessions_dev`)**), prod `pcexxtckvwmiquseznaz` (**48 migrations — `20260904090000`/`20260904120000` via prod MCP, `20260904150000` applied prod `recover_stuck_received_sessions`; `migration list` dev & prod now match repo**)
