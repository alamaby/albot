...
- CLOSED 2026-08-26: recovery cron prod terverifikasi — 18 scheduled runs awal gagal 401 (GitHub auto-created environment `recovery-production` kosong tanpa secret; pelajaran: environment yang direferensikan workflow TIDAK otomatis punya secret). Setelah user isi secret → manual dispatch + scheduled run hijau (03:17/03:28 UTC). Known limitation "cron hanya dev" resmi tertutup.
