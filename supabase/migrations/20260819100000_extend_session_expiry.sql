-- Milestone 5: extend session expiry from 30 minutes to 24 hours.
--
-- The 30-minute expiry measured from the first prompt was too short for a
-- real user flow (enhancement, confirmation, generate, revise, complete can
-- span much longer). Re-create create_initial_session with a 24-hour window.
-- Existing sessions keep their original expires_at; new sessions get 24h.
