...
- Double-tap model switch → enqueue job ganda: `limit 5` + `queued|processing` guard + `create_generation_attempt` DB guard mencegah 2 processing simultan; last-write-wins.
